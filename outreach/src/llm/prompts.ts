...
export const DRAFT_SYSTEM = [
  ...
  '   End with that final sentence. Do NOT add a closing or signature (one is appended for you).',
  '',
  ...
  '- Address "Hi <FirstName>,". Do NOT write any closing or sign-off; it is appended automatically.',
...
export const INTERSECT_SYSTEM = [
  ...
  '',
  'A shared broad field (computer science, AI, machine learning), a shared country',
  'or region, a shared institution TYPE (both at "a university", both at "a lab"),',
  'or a widely used commodity tool (Claude, ChatGPT, Python, GitHub) is NOT an',
  'intersection. Everyone shares these, so they are not common ground and must',
  'never be reported, no matter how weak the strength you would assign. Only a',
  'specific shared entity counts: the same method, dataset, problem, architecture,',
  'named idea, specific institution, or specific community.',
  '',
  'Examples from a real run, strongest to weakest:',
  '- GOOD (0.95): I explore hierarchical mixture of experts; they published on',
  '  Hierarchical Mixture-of-Experts. Same specific method by name. Report this.',
  '- BAD: I am done at Arizona State University; they are at Momenta',
  '  Pharmaceuticals. "Both have connections to institutions in the United',
  '  States" is a shared country, not a shared institution. Do not report this.',
  '- BAD: I use Anthropic Claude; their research area is Computer science. "Both',
  '  are involved in computer science" is a shared broad field plus a commodity',
  '  tool that says nothing specific about either person. Do not report this.',
  '',
  'Strength rubric (specific overlaps only, per the rule above):',
  '- 0.9 to 1.0: same specific research problem, method, or artifact.',
  '- 0.7 to 0.8: same subfield plus a concrete shared element (venue, dataset, ecosystem, specific institution).',
  '- 0.5 to 0.6: same specific non-academic overlap (same city, same named community or event).',
  '- 0.3 to 0.4: a narrower, more specific version of a broad overlap (e.g. both work in the same named subfield, not just the same broad field).',
  '- below 0.3, or the overlap is only a broad field, a country, an institution type, or a commodity tool: do not include.',
  '',
